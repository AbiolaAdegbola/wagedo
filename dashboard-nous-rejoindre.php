...
<table class="table">
  ...
  <?php 
	include 'connexionBdd.php';
     $data = $bdd->query('SELECT * FROM nous_rejoindre ORDER BY id desc');
    $u = 1;
     while ($result = $data->fetch()) {
       ?>
   
      <tr class="success onclickDetailModal" style="font-size: 12px" data-id="<?php echo($result['id'].'@]'."nous_rejoindre"); ?>">
        ...
        <td width="150px"><?php echo($result['profession']); ?></td>
