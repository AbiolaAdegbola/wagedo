    ...
    <tbody>
      ...
      ?>
        <tr class="success" style="font-size: 12px; cursor: normal">
          ...
          <td width="100px">
            <a href="blog-single.html?categorie=<?= urlencode($result['categorie']); ?>&titre=<?= urlencode($result['titre']); ?>&id=<?= $result['id']; ?>" style="color:blue; font-size:15px; margin-right:10px">
              <i class="bi bi-eye"></i>
            </a>
